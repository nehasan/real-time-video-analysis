...
#cap=cv2.VideoCapture('./data/video/test.mp4') #0 for 1st webcam
...
def deepsort():
    ...
    while True:
        ...
        cv2.putText(frame, "Tracked: {}".format(count), (5, 35), cv2.FONT_HERSHEY_COMPLEX_SMALL, 2, (0, 255, 0), 2)
        print("Tracked: {}".format(count))
